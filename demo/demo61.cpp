 ...
 */
   ...
   GetXMLBuffer(strrecvbuffer,"num",num,50);
   cout<<num[0]<<endl;
   int number =(int)num[0]+100;
   
   string s = "<retcode>1</retcode><num>" + to_string(number) + "</num>";
    
   sprintf(strsendbuffer,s.c_str());
...
*/
  ...
  char num[51];
   ...
   string s = "<bizcode>2</bizcode><num>" + to_string(number) + "</num>";
